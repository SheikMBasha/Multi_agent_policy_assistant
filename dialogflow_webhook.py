...
#     # Respond quickly to Dialogflow within 5 sec
#     response = {
#         "fulfillmentText": "I'm checking that for you, Mr. Basha. Please hold on..."
#     }
 
#     # Now process RAG separately
#     asyncio.create_task(handle_rag_logic(user_query))
